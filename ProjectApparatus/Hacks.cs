...
namespace ProjectApparatus
{
    ...
    internal class Hacks : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            ...
            string Watermark = "Project Apparatus | Fixed By Astolfo (MuttBust)";
            if (!SettingsData.b_CenteredIndicators)
            {
                if (TimeOfDay.Instance != null)
                {
            ...
            {
                Settings.windowRect = GUILayout.Window(0, Settings.windowRect, new GUI.WindowFunction(this.MenuContent), "Project Apparatus", Array.Empty<GUILayoutOption>());
            }
